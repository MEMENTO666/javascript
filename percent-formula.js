...
1.// todo 전체값에서 일부값 퍼센트 구하기 : 일부값 / 전체값 * 100
2.// todo 전체값에서 몇 퍼센트는 얼마인지 구하기 : 전체값 * 퍼센트 / 100
3.// todo 숫자를 몇 퍼센트 증가시키는 공식 : 숫자  (1 + 퍼센트 / 100)
4.// todo 숫자를 몇 퍼센트 감소하는 공식 : 숫자  (1 - 퍼센트 / 100)
